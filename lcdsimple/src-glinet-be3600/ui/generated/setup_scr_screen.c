...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen, 284, 100);
    lv_obj_set_scrollbar_mode(ui->screen, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0x978bff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_label_3
    ui->screen_label_3 = lv_label_create(ui->screen);
    lv_obj_set_pos(ui->screen_label_3, 0, 0);
    lv_obj_set_size(ui->screen_label_3, 284, 76);
    ...
    lv_obj_set_style_bg_color(ui->screen_label_3, lv_color_hex(0xf9ff00), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_1, 9, 3);
    lv_obj_set_size(ui->screen_label_1, 100, 32);
    lv_label_set_text(ui->screen_label_1, "你好啊");
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_SourceHanSansCN_Normal_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_label_1, lv_color_hex(0x8bffd1), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_2, 162, 11);
    lv_obj_set_size(ui->screen_label_2, 100, 32);
    lv_label_set_text(ui->screen_label_2, "for测试内容");
    ...
    lv_obj_set_style_bg_color(ui->screen_label_2, lv_color_hex(0x00f4f7), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 53, 38);
    lv_obj_set_size(ui->screen_btn_1, 66, 36);
    ui->screen_btn_1_label = lv_label_create(ui->screen_btn_1);
    lv_label_set_text(ui->screen_btn_1_label, "测试旋转");
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_1, lv_color_hex(0xf700e1), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_1, &lv_font_SourceHanSansCN_Normal_16, LV_PART_MAIN|LV_STATE_DEFAULT);
